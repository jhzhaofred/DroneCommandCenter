 ...
 */
- (NSArray<DJICustomUnlockZone *> * _Nullable)getCustomUnlockZones;


/**
 *  Enables an Custom Unlock Zones that is on the aircraft. All Custom Unlock Zones
 *  on the  aircraft can be retrieved with `getCustomUnlockZones`.  At any time,
 *  only one Custom Unlock Zone can be enabled. Enabling an Custom Unlock Zone will
 *  disable the previously enabled zone. This method can only be used when
